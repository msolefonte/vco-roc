...
local function check_vco_roc_cth_the_western_provinces_caravans(faction_key)
  ...
  if num_caravans_completed < REQUIRED_NUM_CARAVANS_COMPLETED_VICTORY then
    set_mission_text("vco_roc_cth_the_western_provinces_caravans",
                     "vco_roc_cth_the_western_provinces_caravans_" .. num_caravans_completed);
  else
    set_mission_text("vco_roc_cth_the_western_provinces_caravans", "vco_roc_cth_the_western_provinces_caravans");
    complete_mission("wh3_main_cth_the_western_provinces", "vco_roc_cth_the_western_provinces_caravans");
  end
end
...
local function check_vco_roc_cth_the_western_provinces_goods(faction_key)
  ...
  if total_goods_moved < REQUIRED_TOTAL_GOODS_MOVED_VICTORY then
    ...
    set_mission_text("vco_roc_cth_the_western_provinces_goods",
                     "vco_roc_cth_the_western_provinces_goods_" .. percentage_completed);
  else
    set_mission_text("vco_roc_cth_the_western_provinces_goods", "vco_roc_cth_the_western_provinces_goods");
    complete_mission("wh3_main_cth_the_western_provinces", "vco_roc_cth_the_western_provinces_goods");
  end
end
...
local function check_vco_roc_daemons_of_chaos_the_great_game(faction_key, corruption_key)
  ...
  if corrupted_regions < REQUIRED_CORRUPTED_REGIONS_VICTORY then
    set_mission_text("vco_roc_" .. faction_key .. "_the_great_game",
                     "vco_roc_the_great_game_completed_" .. corrupted_regions);
  else
    set_mission_text("vco_roc_" .. faction_key .. "_the_great_game", "vco_roc_the_great_game_completed");
    complete_mission(faction_key, "vco_roc_" .. faction_key .. "_the_great_game");
  end
end
...
local function check_vco_roc_ogre_kingdoms_the_maw_that_walks(context)
  ...
  if total_meat_offered < REQUIRED_MEAT_OFFERED_VICTORY then
    ...
    set_mission_text("vco_roc_ogr_the_maw_that_walks", "vco_roc_ogr_the_maw_that_walks_" .. percentage_completed);
  else
    set_mission_text("vco_roc_ogr_the_maw_that_walks", "vco_roc_ogr_the_maw_that_walks");
    complete_mission(context:faction():name(), "vco_roc_ogr_the_maw_that_walks");
  end
end
